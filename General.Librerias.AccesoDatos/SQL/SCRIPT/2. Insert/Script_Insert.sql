...
INSERT Sistema_Opcion
(eIdModulo, eIdOpcionPadre, vNombre, vRuta, vIcon, vNuOrden, dFechaRegistro, vUsuarioRegistro, vIdPcRegistro, dFechaActualiza, vUsuarioActualiza, vIdPcActualiza, bActivo)
SELECT 2, 1,'PRUEBA', 'Almacen/Almacen/Prueba', 'fa-snowflake-o', '2', GETDATE(),'DARROYO','127.0', GETDATE(), '', '', '1'
...
(eIdCatalogo, vDni, vNombre, vApellidoPaterno, vApellidoMaterno, vSexo, vTelefono, vCorreo, vDireccion, vArchivoFoto, dFechaRegistro, vUsuarioRegistro, vIdPcRegistro,
dFechaActualiza, vUsuarioActualiza, vIdPcActualiza, bActivo)
SELECT 2,'10203040','DANIEL','ARROYO','ALVARADO','M','999888777','DARROYO@GMAIL.COM','AV SERGIO','',GETDATE(),'DARROYO','127.0',GETDATE(),'','','1'
INSERT General_Persona
(eIdCatalogo, vDni, vNombre, vApellidoPaterno, vApellidoMaterno, vSexo, vTelefono, vCorreo, vDireccion, vArchivoFoto, dFechaRegistro, vUsuarioRegistro, vIdPcRegistro,
dFechaActualiza, vUsuarioActualiza, vIdPcActualiza, bActivo)
SELECT 2,'10203043','ERICK','LUCIANI','CACERES','M','999888777','ELUCIANI@GMAIL.COM','AV SERGIO','',GETDATE(),'DARROYO','127.0',GETDATE(),'','','1'
INSERT General_Persona
(eIdCatalogo, vDni, vNombre, vApellidoPaterno, vApellidoMaterno, vSexo, vTelefono, vCorreo, vDireccion, vArchivoFoto, dFechaRegistro, vUsuarioRegistro, vIdPcRegistro,
dFechaActualiza, vUsuarioActualiza, vIdPcActualiza, bActivo)
SELECT 2,'10203041','CARLOS','CALLAGUA','TORRES','M','999888777','CCALLAGUA@GMAIL.COM','AV SERGIO','',GETDATE(),'DARROYO','127.0',GETDATE(),'','','1'
INSERT General_Persona
(eIdCatalogo, vDni, vNombre, vApellidoPaterno, vApellidoMaterno, vSexo, vTelefono, vCorreo, vDireccion, vArchivoFoto, dFechaRegistro, vUsuarioRegistro, vIdPcRegistro,
dFechaActualiza, vUsuarioActualiza, vIdPcActualiza, bActivo)
SELECT 2,'10203042','JAER','BERNACHEA','TORRES','M','999888777','JBERNACHEA@GMAIL.COM','AV SERGIO','',GETDATE(),'DARROYO','127.0',GETDATE(),'','','1'
